...
export default function AdminLayout({ children }: { children: ReactNode }) {
  return (
    <div className="flex h-screen bg-gray-100 font-sans">
      {/* Sidebar */}
      <aside className="w-64 bg-[var(--first-color)] text-white shadow-md">
        <div className="p-6">
        ...
        <nav className="mt-6 flex flex-col gap-2 px-4">
          <Link 
            href="/admin" 
            className="flex items-center gap-3 px-4 py-3 bg-[var(--first-color-alt)] rounded-lg transition-colors"
          >
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        <header className="bg-white shadow px-8 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="w-8 h-8 rounded-full bg-green-200 flex items-center justify-center text-green-800 font-bold">A</div>
          </div>
        </header>
